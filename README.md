...
Custom fork:
* Replaced setInterval in favor of requestAnimationFrame (https://github.com/logicbox/jquery-simplyscroll/pull/12)
* Extra option (initialOffset) to allow the scroller to begin at a position other than 0px. (https://github.com/logicbox/jquery-simplyscroll/pull/10)
